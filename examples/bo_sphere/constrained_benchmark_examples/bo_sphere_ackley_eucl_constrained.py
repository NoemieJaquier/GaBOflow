...
from BoManifolds.BO_utils.constrained_optimization import SciPyOptimizerWithConstraints, \
    AnchorPointsGeneratorWithNormConstraintInDomain
...
In this example, the search domain is bounded and represents a subspace of the manifold.
...
if __name__ == "__main__":
    ...
    # Sample function for the sphere with constraints (for initial evaluations)
    ...
    # The bound constraints are here handled by defining a restricted domain
    ...
    acq_fct_opt = MultistartedOptimizer(domain, SciPyOptimizerWithConstraints(domain=domain,
                                                                              ...
                                                                              method='SLSQP', maxiter=300),
                                        AnchorPointsGeneratorWithNormConstraintInDomain(domain=domain, norm=1.))
    ...
    # Conpute best evaluation for each iteration

...
The acquisition function is optimized on the manifold with the conjugate gradient descent method on Riemannian manifold, 
...
if __name__ == "__main__":
    ...
    acq_fct_opt = MultistartedOptimizer(domain, ManifoldOptimizer(domain=domain, manifold=sphere_manifold,
                                                                  manifold_dim=dim,
                                                                  solver_type='ConjugateGradientRobust'),
    ...
    if display_figures:
        ...
        # Plot true minimum
        ax.scatter(true_min[0, 0], true_min[0, 1], true_min[0, 2], s=80, c='g', marker='P')
        # Plot BO minimum
        ax.scatter(Bopt.x[0, 0], Bopt.x[0, 1], Bopt.x[0, 2], s=50, c='r', marker='D')

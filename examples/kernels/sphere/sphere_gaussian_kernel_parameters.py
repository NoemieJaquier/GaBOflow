...
from BoManifolds.Riemannian_utils.sphere_utils import expmap
...
def align_yaxis(axis1, v1, axis2, v2):
...
if __name__ == "__main__":
    ...
    dim = 4  # Dimension of the manifold
    ...
    for trial in range(nb_trials):
        ...
        # This way of sampling is not extremely rigorous. The sampling should be done on the tgt space and projected on
        # the manifold. However, it should be sufficient for the current purpose.
        # Sample data
        ...
        # Minimum eigenvalue of the kernels
